<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            <title>Lista de Ordenadores - Gestión de Prestadores</title>
            <!-- Bootstrap 5 CSS -->
        ...
        <body class="bg-light d-flex flex-column min-vh-100">
            ...
            <div class="container mt-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="ordenadores?action=new" class="btn btn-success"><i class="bi bi-plus-circle me-1"></i>
                        Nuevo ordenador</a>
                </div>
            ...
            <script>
                $(document).ready(function () {
                    $('#ordenadoresTable').DataTable({
                        "processing": true,
                        "serverSide": true,
                        "responsive": true,
                        "autoWidth": false,
                        "ajax": {
                            "url": "ordenadores?action=data",
                            "type": "POST"
                        },
                        "columns": [
                            { "data": 0 }, // Nombre
                ...
                function confirmarEliminar(id) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = 'ordenadores?action=delete&id=' + id;
                        }
                    });
                }
            </script>
