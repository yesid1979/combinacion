        ...
        <body class="bg-light d-flex flex-column min-vh-100">
            ...
            <div class="container mt-4 mb-5 flex-grow-1">
                ...
                <div class="row g-4 justify-content-center">
                    ...
                    <c:if test="${sessionScope.usuario.tienePermiso('PUEDE_REVISAR_CUENTAS') || sessionScope.usuario.tienePermiso('REVISION_CUENTAS_VER') || sessionScope.usuario.tienePermiso('ADMINISTRAR_CUENTAS')}">
                    <div class="col-md-6 col-lg-3">
