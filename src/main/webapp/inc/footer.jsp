...
<footer class="footer-simple">
    <div class="container-fluid d-flex flex-column flex-md-row justify-content-between align-items-center text-center">
        <div class="mb-2 mb-md-0">
            <span>&copy; 2026 <span class="text-highlight">DAGJP</span>. Todos los derechos reservados. <br class="d-md-none">| Dise&ntilde;ado por: Ing. Yesid Javier Piedrahita Correa</span>
        </div>
