...
public class CargaMasivaService {
    ...
    public void procesarCargaMasiva(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private Map<String, Integer> mapHeaders(String[] header, StringBuilder log) {
        ...
        for (int i = 0; i < header.length; i++) {
            ...
            } else if ((h.contains("numero") || h.contains("num") || h.contains("nro") || h.contains("no.") || h.contains("#")) && h.contains("cuota") && h.contains("adicion")) {
