...
import com.combinacion.util.FormatUtil;
import java.io.File;
...
public class CombinacionService {
    ...
    private java.util.Map<String, byte[]> templateCache = new ConcurrentHashMap<>();
...
public void generarDocumentoIndividual(HttpServletRequest request, HttpServletResponse response)
            throws IOException {
        try {
            ...
            if (esInversion && contrato != null) {
                ...
                for (String tpl : new String[]{"INVERSION_1_ESTUDIOS_PREVIOS.docx", "INVERSION_2_VERIFICACION_CUMPLIMIENTO.docx", "INVERSION_3_CERTIFICADO_IDONEIDAD.docx", complementoDoc}) {
                    ...
                    if (replacements != null) {
                        byte[] fileBytes = generateBytes(request, tpl, replacements);
                        if (fileBytes != null) {
                            String baseName = "";
    ...
    public void generarEstructuradoresMasivoZip(HttpServletRequest request, HttpServletResponse response) throws IOException {
        String idsParam = request.getParameter("ids");
    ...
    public void generarDesignacionMasivoZip(HttpServletRequest request, HttpServletResponse response) throws IOException {
        String idsParam = request.getParameter("ids");
    ...
    private byte[] generateBytes(HttpServletRequest request, String templateName, Map<String, String> replacements) throws IOException {
        byte[] templateBytes = templateCache.get(templateName);

        if (templateBytes == null) {
            String realPath = request.getServletContext().getRealPath("/plantillas/" + templateName);
    ...
    private Map<String, String> getCommonReplacements(Contratista contratista, Contrato contrato,
        ...
        if (presupuesto != null) {
            ...
            replacements.put("{{VALOR_CDP}}", cdpVal != null ? FormatUtil.formatearMoneda(cdpVal) : "");
            replacements.put("{{CDP_VALOR}}", cdpVal != null ? FormatUtil.formatearMoneda(cdpVal) : "");
            ...
            String cdpLetras = cdpVal != null ? FormatUtil.convertirMontoALetras(cdpVal) : "";
            ...
            String cdpLetrasMin = !cdpLetras.isEmpty() ? FormatUtil.capitalizeFirst(cdpLetras) : "";
            ...
            if (valAdicion != null) {
                replacements.put("{{VALOR_CDP_ADICION}}", FormatUtil.formatearMoneda(valAdicion));
                replacements.put("{{VALOR_CDP_ADICION_LETRAS}}", FormatUtil.convertirMontoALetras(valAdicion));
            } else {
        ...
        if (contrato.getValorTotalNumeros() != null) {
            replacements.put("{{VALOR_CONTRATO}}", FormatUtil.formatearMoneda(contrato.getValorTotalNumeros()));
        } else {
        ...
        if (contrato.getValorAntesIva() != null) {
            replacements.put("{{VALOR_ANTES_IVA}}", FormatUtil.formatearMoneda(contrato.getValorAntesIva()));
        } else {
        ...
        if (contrato.getValorIva() != null) {
            replacements.put("{{VALOR_IVA}}", FormatUtil.formatearMoneda(contrato.getValorIva()));
        } else {
        ...
        if (contrato.getValorCuotaAntesIva() != null) {
            replacements.put("{{VALOR_CUOTA_ANTES_IVA}}", FormatUtil.formatearMoneda(contrato.getValorCuotaAntesIva()));
        } else {
        ...
        if (contrato.getValorCuotaIva() != null) {
            replacements.put("{{VALOR_CUOTA_IVA}}", FormatUtil.formatearMoneda(contrato.getValorCuotaIva()));
        } else {
        ...
        if (contrato.getNumeroCuotasAdicion() > 0) {
            replacements.put("{{NUMERO_CUOTAS_ADICION_LETRAS}}", FormatUtil.convertirNumeroALetras(contrato.getNumeroCuotasAdicion()));
        } else {
        ...
        replacements.put("{{VALOR_TOTAL_ADICION}}", contrato.getValorTotalAdicion() != null ? FormatUtil.formatearMoneda(contrato.getValorTotalAdicion()) : "");
        ...
        replacements.put("{{VALOR_CONTRATO_MAS_ADICION}}", contrato.getValorContratoMasAdicion() != null ? FormatUtil.formatearMoneda(contrato.getValorContratoMasAdicion()) : "");
        ...
        String constanciaFecha = "a los " + FormatUtil.convertirNumeroALetras(diaHoy).toLowerCase() + " (" + diaHoy + ") días del mes de " + mesHoyStr + " del año " + anioHoy;
        ...
        // Values
        if (contrato.getValorTotalNumeros() != null)
            replacements.put("${VALOR_TOTAL}", FormatUtil.formatearMoneda(contrato.getValorTotalNumeros()));
        else
            replacements.put("${VALOR_TOTAL}", "0");

        if (contrato.getValorCuotaNumero() != null)
            replacements.put("${VALOR_MENSUAL}", FormatUtil.formatearMoneda(contrato.getValorCuotaNumero()));
        else
        ...
        if (contrato.getValorCuotaNumero() != null) {
            replacements.put("{{VALOR_CUOTA_NUMERO}}", FormatUtil.formatearMoneda(contrato.getValorCuotaNumero()));
        } else {
        ...
        if (ordenador != null) {
            ...
            replacements.put("{{ORGANISMO}}",
                    ordenador.getOrganismo() != null ? ordenador.getOrganismo() : "");
            replacements.put("${ORGANISMO_ORDENADOR}",
                    ordenador.getOrganismo() != null ? FormatUtil.toTitleCase(ordenador.getOrganismo()) : "");
        ...
        if (presupuesto != null) {
            ...
            replacements.put("{{CDP_VALOR}}", presupuesto.getCdpValor() != null ? FormatUtil.formatearMoneda(presupuesto.getCdpValor()) : "");
        } else {
        ...
        String diaLetras = FormatUtil.convertirNumeroALetras(dia);
        ...
        if (usuarioLogueado != null) {
            String nombreTitleCase = FormatUtil.toTitleCase(usuarioLogueado.getNombreCompleto());
            String vinculacionTitleCase = FormatUtil.toTitleCase(usuarioLogueado.getCargo());
        ...
        if (realTemplateName != null) {
            ...
            if (revisor != null) {
                String revisorNombre = FormatUtil.toTitleCase(revisor.getNombreCompleto());
                String revisorCargo = FormatUtil.toTitleCase(revisor.getCargo());
    ...
    private byte[] generarBytesDocumento(HttpServletRequest request, int contratistaId, String docType) throws Exception {
        ...
        return generateBytes(request, templateName, replacements);
    }
    ...
    public void generarModificacionIndividual(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try {
            int contratistaId = Integer.parseInt(request.getParameter("id"));
            Contratista c = contratistaDAO.obtenerPorId(contratistaId);
            String cedula = (c.getCedula() != null ? c.getCedula() : "Doc");
            ...
            if (esAdicion) {
                ...
                for (String[] par : plantillas) {
                    ...
                    byte[] docxBytes = generateBytes(request, par[0], replacements);
                    if (docxBytes != null) {
    ...
    public void generarModificacionMasivoZip(HttpServletRequest request, HttpServletResponse response) throws IOException {
        String idsParam = request.getParameter("ids");
        if (idsParam == null || idsParam.isEmpty()) {
            response.sendError(HttpServletResponse.SC_BAD_REQUEST, "No se seleccionaron contratistas");
            return;
    ...
    private String formatearFechaLargaLegal(java.util.Date fecha) {
        ...
        String diaLetras = FormatUtil.convertirNumeroALetras(dia).toLowerCase();
